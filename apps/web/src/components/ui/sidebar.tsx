...
function SidebarProvider({
  ...
  return (
    <SidebarContext value={contextValue}>
      <div
        className={cn(
          "group/sidebar-wrapper flex min-h-(--app-viewport-height,100svh) w-full has-data-[variant=inset]:bg-sidebar",
          className,
        )}
  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-(--app-viewport-height,100svh) w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
